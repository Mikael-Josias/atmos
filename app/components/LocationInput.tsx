...
import { GeocodingObject, GeocodingResults, getGeocoding, getReverseGeocoding } from "../services/LocationAPI"
...
export default function LocationInput() {
  ...
  const [disabledGetLocationButton, setDisabledGetLocationButton] = useState(false)
  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between bg-background pl-3 pr-3 rounded-full my-2">
        ...
        <button className="hover:bg-cement_400 h-min w-min p-1 rounded-full text-cement_400 hover:text-white transition-colors" onClick={(e) => getLocation(e)} disabled={disabledGetLocationButton}>
          <Locate size={18} />
        </button>
      </div>
